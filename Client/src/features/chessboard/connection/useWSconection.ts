...
export const useWSconnection = ( userid: string, OnGameFinished: () => void, OnRegister: (isWhite: boolean) => void, OnReceiveMessage: (message: ChessMessage) => void, OnRefreshPosition: (fen: string) => void, connectionEndpoint: string) : [(message: ChessMessage) => void] => {
