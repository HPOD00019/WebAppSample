using GameEngineService.Api.MassTransit.Consumers;
using GameEngineService.Api.MassTransit.MessageServices;
using GameEngineService.Domain.Services;
using MassTransit;
using MassTransit.Conracts.Commands;

namespace GameEngineService.Api.MassTransit
{
    public static class MassTransitRegistration
    {
        public static IServiceCollection RegisterMassTransitServices(this IServiceCollection services, IConfigurationSection settings)
        {
            ...
            {
                context.AddConsumers(typeof(CreateMatchRequestConsumer).Assembly);
